...
export interface ApiGraphicGraphic extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Studio graphics library';
    displayName: 'Graphic';
    pluralName: 'graphics';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['logos', 'icons', 'badges', 'patterns', 'custom']
    > &
      Schema.Attribute.DefaultTo<'icons'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMockupMockup extends Struct.CollectionTypeSchema {
  collectionName: 'mockups';
  info: {
    description: 'Studio garment mockups';
    displayName: 'Mockup';
    pluralName: 'mockups';
    singularName: 'mockup';
  };
